...
function insertKatas(katasData) {
    return __awaiter(this, void 0, void 0, function* () {
        const katasQuery = format("INSERT INTO katas (kata_name, description, test_path, difficulty, function_template) VALUES %L RETURNING *;", katasData.map(({ kata_name, description, test_path, difficulty, function_template, }) => [kata_name, description, test_path, difficulty, function_template]));
...
function insertKataTopics(kataTopicsData) {
    return __awaiter(this, void 0, void 0, function* () {
        const kataTopicsQuery = format("INSERT INTO kata_topics (kata_id, topic_id) VALUES %L RETURNING *;", kataTopicsData.map(({ kata_id, topic_id }) => [
            kata_id,
            topic_id,
        ]));
